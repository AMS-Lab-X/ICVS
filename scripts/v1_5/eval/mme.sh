...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file /home/cwd/codes/SparseVLMs-1.5/outputs/TADHS/MME/answers/llava-v1.5-7b-64.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --retained_tokens 64 \
    --log-file  /home/cwd/codes/SparseVLMs-1.5/outputs/TADHS/MME/logs/llava-v1.5-7b-64.log \
    --classifier-path ./checkpoints/prompt_classifier_add/best_model.pth

cd ./playground/data/eval/MME
mkdir -p answers
ln -sf /home/cwd/codes/SparseVLMs-1.5/outputs/TADHS/MME/answers/llava-v1.5-7b-64.jsonl \
